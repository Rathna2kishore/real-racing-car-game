...
# lode the other cars
image_filenames = ["car1.png", "car2.png", "car3.png", "car4.png", "car5.png", "car6.png", ]
car_images = []
...
while running:
    ...
    if game_over:
        ...
        text3 = font3.render(f'Game Over. Your Score: {score}. Play again? (enter P or N)', True, white)
